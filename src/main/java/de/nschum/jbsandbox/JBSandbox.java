...
import de.nschum.jbsandbox.ui.EditorWindowController;
...
public class JBSandbox {
    ...
    public static void main(String[] args) {
        ...
        EditorWindowController.showNewEditorWindow(args.length > 0 ? Optional.of(new File(args[0])) : Optional.empty());
    }
